...
<div id="content">
<div id="breadcrumb">
    <a href="#" title="商品管理" class="tip-bottom"><i class="icon-home"></i>企业评价</a>
    <a href="#" class="current">企业评价</a>
</div>
        ...
        <div class="span12">
            <div class="widget-box collapsible">
                ...
                <div id="collapseOne" class="collapse in">
                    <div class="widget-content">对企业评价信息进行相关操作。</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="span12">
        <div class="widget-box widtable-box">
            <div class="outer-box">
                ...
                <div>
                	<form method="post" id="requestForm" action="<%=path%>/testerminal/getAllTesterminal">
